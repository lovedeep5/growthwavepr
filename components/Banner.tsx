...
const Banner = () => {
  return (
    <div className="banner h-[300px] md:h-[calc(100vh-211px)] bg-black w-full bg-cover bg-center  bg-[url('/salon1.jpg')] relative">
      <div className="inner absolute inset-0  backdrop-brightness-50 flex flex-col justify-end items-start bg-primary/40">
        <div className="discount bg-primary p-6 text-center">
